package com.devgeek.sharedviewmodelbasicsample.viewModel
...
/**
 * [OrderViewModel] holds inforamtion about a cupcake order in terms of quantity, flavor, and
...
class OrderViewModel : ViewModel() {
    ...
    /**
     * seth the quntity of cupcakes for this order.
     *
    ...
    /**
     * Returns true if a flavor has not been selected for the order yet.

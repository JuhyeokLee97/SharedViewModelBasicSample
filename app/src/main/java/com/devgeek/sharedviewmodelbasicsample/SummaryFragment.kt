...
import com.devgeek.sharedviewmodelbasicsample.databinding.FragmentSummaryBinding
...
class SummaryFragment : Fragment() {
    ...
    /**
     * Submit the order by sharing out the order details to another app
     * via an implicit intent.
     */
    fun sendOrder(){
